                ...
                <div className="row mt-3">
                    <div className="col-12 col-sm-6 ">
                        <div className={width < 516 ? "d-flex p-3 justify-content-center":"d-flex p-3 justify-content-end"}>
                            ...
                            <div className="mx-3 mt-2 w-50"><strong>Ambiente Acolhedor:</strong> Ao entrar no café, os
                        ...
                        <div className={width < 516 ? "d-flex p-3 justify-content-center":"d-flex p-3 justify-content-end"}>
                            ...
                            <div className="mx-3 mt-2 w-50"><strong>Equipe Amigável:</strong> Nossa equipe é composta por
                        ...
                        <div className={width < 516 ? "d-flex p-3 justify-content-center":"d-flex p-3 justify-content-end"}>
                            ...
                            <div className="mx-3 mt-2 w-50"><strong>Produtos Locais:</strong> NNosso café se orgulha de apoiar produtores locais, utilizando grãos de café de fazendas regionais e oferecendo uma variedade de produtos de padarias locais e fornecedores artesanais.
                            </div>
                        </div>
                    </div>
                    <div className="col-12 col-sm-6">
                        <div
                            ...
                            <div className="mx-3 mt-2 w-50"><strong>Opções Saudáveis:</strong>
                        ...
                        <div
                            ...
                            <div className="mx-3 mt-2 w-50"><strong>Wi-Fi Grátis:</strong>
                        ...
                        <div
                            ...
                            <div className="mx-3 mt-2 w-50"><strong>Compromisso com a Sustentabilidade: </strong>
